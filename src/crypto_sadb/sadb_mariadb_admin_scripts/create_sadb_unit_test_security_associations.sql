...
-- SA 1 - CLEAR MODE
INSERT INTO security_associations (spi,sa_state,est,ast,arsn_len,arsn,arsn_win_len,arsn_win,tfvn,scid,vcid,mapid)
...
INSERT INTO security_associations (spi,ekid,sa_state,est,ast,shivf_len,iv_len,iv,abm_len,abm,arsn_win_len,arsn_win,arsn_len)
...
INSERT INTO security_associations (spi,ekid,sa_state,est,ast,shivf_len,stmacf_len,iv_len,iv,abm_len,abm,arsn_win_len,arsn_win,arsn_len)
...
INSERT INTO security_associations (spi,ekid,sa_state,est,ast,shivf_len,iv_len,iv,abm_len,abm,arsn_win_len,arsn_win,arsn_len,tfvn,scid,vcid,mapid)
...
INSERT INTO security_associations (spi,sa_state,est,ast,shivf_len,iv_len,iv,abm_len,abm,arsn_win_len,arsn_win,arsn_len)

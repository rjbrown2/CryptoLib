...
(
  ...
  ,arsn VARBINARY(20) NOT NULL DEFAULT X'0000000000000000000000000000000000000000' -- ARC_SIZE=20 , TBD why so large...
  ,arsn_win_len SMALLINT
  ,arsn_win SMALLINT NOT NULL DEFAULT 0 -- ARCW_SIZE=1
);

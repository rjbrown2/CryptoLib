...
UTEST(TC_APPLY_SECURITY, HAPPY_PATH_ENC_CBC_KMC)
{
    ...
    Crypto_Config_Kmc_Crypto_Service("https", "itc-kmc.nasa.gov", 8443, "crypto-service","/certs/ammos-ca-bundle.crt",NULL, CRYPTO_FALSE, CLIENT_CERTIFICATE, "PEM", CLIENT_CERTIFICATE_KEY, NULL, NULL);
...
UTEST(TC_APPLY_SECURITY, ENC_CBC_KMC_FRAME_MAX)
{
    ...
    char* raw_tc_sdls_ping_h = "";
    char* raw_tc_sdls_ping_b = NULL;
    int raw_tc_sdls_ping_len = 0;
    SadbRoutine sadb_routine = get_sadb_routine_inmemory();
...
UTEST(TC_APPLY_SECURITY, HAPPY_PATH_ENC_CBC_MDB_KMC)
{
    ...
    MDB_DB_RESET();  // Reset Database back to first use for unit testing.
    ...
    char* truth_data_h = "2003002A0000000B0000000000000000000000000000000102FCFCF53E77DDCFD92993273B6C449B76CB7D";
    //char* truth_data_h = "2003001A0000000B025364F9BC3344AF359DA06CA886746F591C8E";
    uint8_t* truth_data_b = NULL;
    int truth_data_l = 0;
...
UTEST(TC_APPLY_SECURITY, ENC_CBC_MDB_KMC_1BP)
{
    ...
    char* truth_data_h = "2003002A0000000B00000000000000000000000000000001011A316550C125825BA5BDC208BA76994E72BB";
    uint8_t* truth_data_b = NULL;
    int truth_data_l = 0;
...
UTEST(TC_APPLY_SECURITY, ENC_CBC_MDB_KMC_16BP)
{
    ...
    char* truth_data_h = "2003003A0000000B0000000000000000000000000000000110CC4B9E52A4EA463350080F8C3E4EBC1B8995C75B90A4C835DBA19E66236C94835A9B";
    uint8_t* truth_data_b = NULL;
    int truth_data_l = 0;
...
UTEST(TC_PROCESS, HAPPY_PATH_DECRYPT_CBC_MDB_KMC)
{
    ...
    char* test_frame_pt_h = "2003002A0000000B0000000000000000000000000000000102FCFCF53E77DDCFD92993273B6C449B76CB7D";
    uint8_t *test_frame_pt_b = NULL;
    int test_frame_pt_len = 0;
...
UTEST(TC_PROCESS, DECRYPT_CBC_MDB_KMC_1B)
{
    ...
    char* test_frame_pt_h = "2003002A0000000B00000000000000000000000000000001011A316550C125825BA5BDC208BA76994E72BB";
    uint8_t *test_frame_pt_b = NULL;
    int test_frame_pt_len = 0;
...
UTEST(TC_PROCESS, DECRYPT_CBC_MDB_KMC_16B)
{
    ...
    char* test_frame_pt_h = "2003003A0000000B0000000000000000000000000000000110CC4B9E52A4EA463350080F8C3E4EBC1B8995C75B90A4C835DBA19E66236C94835A9B";
    uint8_t *test_frame_pt_b = NULL;
    int test_frame_pt_len = 0;
